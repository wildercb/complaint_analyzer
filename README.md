...
You will also need to add a kubernetes/env-secrets.yaml file with the correct values for the environment variables
...
stringData:
  ...
  OPENAI_API_KEY: 
  GOOGLE_APPLICATION_CREDENTIALS: | # copy and paste from google-service-account.json api key
    {
    }
```
